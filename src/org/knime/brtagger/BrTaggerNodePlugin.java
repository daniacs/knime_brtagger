 ...
 */
public class BrTaggerNodePlugin extends Plugin {
    // The shared instance.
    private static BrTaggerNodePlugin plugin;

    /**
     * The constructor.
     */
    public BrTaggerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BrTaggerNodePlugin getDefault() {
        return plugin;
    }
